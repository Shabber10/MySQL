...
-- ---------------------------------------------------------------------
-- 3. GROUP BY, ORDER BY, & WITH ROLLUP
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 8. System Information & Advanced Date Functions
-- ---------------------------------------------------------------------
...
SELECT TIMESTAMPDIFF(MINUTE, '2026-08-06 10:00:00', '2026-08-06 15:30:00') AS diff_minutes;
SELECT SEC_TO_TIME(3665) AS formatted_time, TIME_TO_SEC('01:01:05') AS total_seconds;
SELECT LAST_DAY('2026-02-15') AS feb_last_day, LAST_DAY(NOW()) AS current_month_end;
SELECT WEEKOFYEAR('2026-08-06') AS iso_week, DAYOFWEEK('2026-08-06') AS day_index;
